          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <BrandName
                  variant="full"
                  className="text-1xl font-bold bg-gradient-to-r from-violet-400 to-violet-600 bg-clip-text text-transparent"
                />
              </div>
              <p className="text-gray-300 leading-relaxed">
                Donde la novia se prepara, el cuerpo se edifica, la cabeza <span className="font-bold text-violet-400">Cristo</span> es glorificada, y cada creyente es enviado a echar raíces en su comunidad.              </p>
            ...
            {/* Enlaces rápidos */}
            <div>
              <h3 className="text-lg font-semibold text-violet-400 mb-6 pb-2 border-b border-gray-700/50">
                Navegación
              </h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item.name}>
                    ...
                    >
                      <span className="w-1.5 h-1.5 bg-violet-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                      {item.name}
                    </Link>
                  </li>
                ))}
              ...
              {/* <div className="mt-8">
                ...
                <div className="flex">
                  <input 
                    ...
                    className="flex-grow px-4 py-2 text-sm text-white bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent"
                  />
                  <button className="bg-violet-500 hover:bg-violet-600 text-white px-4 rounded-r-lg transition-colors duration-300">
